            ...
            <Table stickyHeader>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell sx={{ bgcolor: 'black', color: 'white'}}>Data Perfundimit</TableCell>
                        <TableCell sx={{ bgcolor: 'black', color: 'white'}}>Statusi Ndertimit</TableCell>
                ...
                <TableBody>
                    {Array.from({ length: 50 }, (_, index) => (
                        <TableRow key={index}>
                            ...
                            <TableCell sx={{p: 0, pl: '5px', py: '5px'}}>Dummy Balcony {index + 1}</TableCell>
