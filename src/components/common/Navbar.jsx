    ...
    <>
      {isSmallDev ? (
        <>
          ...
          >
            ...
            <div className="hidden md:flex items-center gap-6">
              <button
                ...
                className="relative inline-flex items-center justify-center px-10 py-3 overflow-hidden text-white bg-transparent rounded-full group border border-secondary"
              >
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center border border-secondary text-white px-5 py-2 rounded-full"
            >
              <svg
                width="24"
                height="25"
              ...
              >
                <path d="M4 18.5C3.72 18.5 3.48 18.4 3.29 18.21C3.1 18.02 3 17.78 3 17.5C3 17.22 3.1 16.98 3.29 16.79C3.48 16.6 3.72 16.5 4 16.5H20C20.28 16.5 20.52 16.6 20.71 16.79C20.9 16.98 21 17.22 21 17.5C21 17.78 20.9 18.02 20.71 18.21C20.52 18.4 20.28 18.5 20 18.5H4ZM4 13.5C3.72 13.5 3.48 13.4 3.29 13.21C3.1 13.02 3 12.78 3 12.5C3 12.22 3.1 11.98 3.29 11.79C3.48 11.6 3.72 11.5 4 11.5H20C20.28 11.5 20.52 11.6 20.71 11.79C20.9 11.98 21 12.22 21 12.5C21 12.78 20.9 13.02 20.71 13.21C20.52 13.4 20.28 13.5 20 13.5H4ZM4 8.5C3.72 8.5 3.48 8.4 3.29 8.21C3.1 8.02 3 7.78 3 7.5C3 7.22 3.1 6.98 3.29 6.79C3.48 6.6 3.72 6.5 4 6.5H20C20.28 6.5 20.52 6.6 20.71 6.79C20.9 6.98 21 7.22 21 7.5C21 7.78 20.9 8.02 20.71 8.21C20.52 8.4 20.28 8.5 20 8.5H4Z" />
              </svg>
            </button>
          </nav>
          ...
          <div
            ref={drawerRef}
            className={`fixed top-0 left-0 w-full h-screen bg-primary z-[300] transform ${isOpen ? "translate-y-0" : "-translate-y-full"
              } transition-transform duration-700 ease-in-out flex flex-col p-10`}
          >
            {/* Close Button */}
            <button
            ...
            <div className="flex flex-col items-center gap-8 text-white mt-16 text-2xl">
              ...
              <button
                ...
                className="border border-secondary px-8 py-3 rounded-full mt-6"
              >
                Selekto Apartmentin
              </button>
              ...
              <button
                ...
                className="border border-secondary px-8 py-3 rounded-full"
              >
                Turi Vizual
              </button>
            </div>
            ...
            {/* Contact Info */}
            <div className="mt-auto text-center text-white text-lg pb-12 space-y-3">
              <p>📞 +383 49 123 123</p>
              <p>📧 info@zambakuresidence.com</p>
              <p>📍 Prizren</p>
            </div>
          </div>
        </>
