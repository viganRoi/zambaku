          ...
          >
            ...
            <div className="flex flex-col items-center gap-8 text-white mt-16 text-2xl">
              ...
              <button
                ...
                className="border border-secondary px-8 py-3 rounded-full text-base"
              >
                Turi Vizual
              </button>
            </div>
            ...
            {/* Contact Info */}
            <div className="mt-auto text-center flex flex-col items-center justify-center text-white text-lg pb-12 space-y-3">
              ...
              <div className="flex items-center gap-2 md:gap-4">
                ...
                <h1 className="text-sm">Prizren</h1>
              </div>
            </div>
          </div>
        </>
