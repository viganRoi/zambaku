...
const Contact = () => {
    ...
    return (
        ...
        >
            ...
            <p className='text-base md:text-2xl text-secondary'>Çdo hap drejt një shtëpie të re nis me një bisedë. Kontaktoni sot<br/> për të zbuluar më shumë mbi Zambaku Residence.</p>
            <h1 className='text-lg md:text-[54px] text-600 text-primary montserrat '>Le të Lidhim Vizionin me Realitetin</h1>
        </div>
    );
};
