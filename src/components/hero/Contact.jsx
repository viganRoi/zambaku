...
const Contact = () => {
    ...
    return (
        ...
        >
            <div className='absolute -top-50 base-width h-80 bg-secondary transition-colors duration-300 hover:bg-gradient-to-t hover:from-secondary/100 hover:to-primary/10 flex flex-col items-center justify-center group'>
                ...
                <div className='absolute -bottom-10 contact-abs w-23/24  flex items-center justify-center overflow-hidden z-10'>
