...
import OffertModal from '../admin/offert/OffertModal';

const ContextMenu = ({ menu, setMenu }) => {
  const dispatch = useDispatch()
  const [offertModalOpen, setOffertModalOpen] = useState(false);
  const status = null
  const handleClose = () => {
    setMenu((prev) => ({
      ...prev,
  ...
  return (
    <>
      ...
      <OffertModal open={offertModalOpen} handleClose={() => setOffertModalOpen(false)} apartmentData={menu?.data} />
    </>
  );
}
